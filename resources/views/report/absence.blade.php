@extends('layouts.app')
@section('title','Absent Students / Employee')
@section('content')

@section('breadcrumbs')
    {{ Breadcrumbs::render('report.absence') }}
@endsection
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            ...
            <div class="panel-body">
                <form action="{{ route('report.absence') }}" method="POST" class="form-horizontal" target="_blank">
                    @csrf
